...
'''
        ...
        ¿Cómo comprobar si un archivo está vacío o no?    https://www.it-swarm.dev/es/python/como-comprobar-si-un-archivo-esta-vacio-o-no/968141004/

    
        import os
        os.stat("file").st_size == 0:
            True
         #SI ES TRUE, ENTONCES EL FILE ESTA VACIO
...
students_list = recibir_datos_del_txt(
    'C:\\Users\DELL\\Desktop\\Prepas-algoritmos\\PREPAS\\weeks\\Week 11\\Herencia y polimorfismo\\Estudiantes.txt', students_list)
...
while out==0:
    ...
    if option==1:
        ...
        cargar_datos_en_txt('C:\\Users\DELL\\Desktop\\Prepas-algoritmos\\PREPAS\\weeks\\Week 11\\Herencia y polimorfismo\\Estudiantes.txt', students_list)
        ...
        positions_in_order(students_list)
        # positions_in_order(professors_list)
        # positions_in_order(preparers_list)
