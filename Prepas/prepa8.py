from prepa8utils import *

#week 11 archivos de recursividad
...
def main():
    db = new_db(products)
    while True:
        op = input('''Welcome, to add a product please press 1. to see the product list please press 2.''')
        
        if op == "1":
            products.__getitem__("type")
            pass
